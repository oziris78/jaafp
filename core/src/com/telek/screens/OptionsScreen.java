...
public class OptionsScreen extends ScreenAdapter implements TScreen {
    ...
    public OptionsScreen(final Jaafp jaafp) {
        ...
        Scene2DUtils.changeFont(label, this.game.assetSorter.getResource("font30", BitmapFont.class));
        ...
        for(TextButton btn : buttons) Scene2DUtils.changeFont(btn, this.game.assetSorter.getResource("font20", BitmapFont.class));
    ...
    private void setupListeners(){
        ...
        btnCloseMusic.addListener(new ChangeListener() {@Override public void changed(ChangeEvent event, Actor actor) {
            if(increaseCloseMusicFont) Scene2DUtils.changeFont(btnCloseMusic, game.assetSorter.getResource("font20", BitmapFont.class));
