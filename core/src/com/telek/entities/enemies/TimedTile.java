...
public class TimedTile {
    ...
    public TimedTile(AssetSorter assetSorter, int mapRowNum, int mapColNum, int horizontalTileNum, int verticalTileNum, float harmlessTime, float damageTime){
        ...
        this.textureRegionForDamage = TelekGDX.getRepeatedTexture(this.textureForDamage, horizontalTileNum, verticalTileNum);
        this.textureRegionForHarmless = TelekGDX.getRepeatedTexture(this.textureForHarmless, horizontalTileNum, verticalTileNum);
